...
export class VideoRoomPage implements OnDestroy {
  currentUser: User;
  currentUserSubscription: Subscription;

  OPENVIDU_SERVER_URL = "https://138.4.10.65:4443";
  OPENVIDU_SERVER_SECRET = "gbttel";
  ...
  getToken(): Promise<string> {
    if (
      ...
      this.OPENVIDU_SERVER_URL = "https://138.4.10.65:4443";
    }
